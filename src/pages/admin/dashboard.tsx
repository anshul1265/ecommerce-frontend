...
const { lastSixMonth } = getLastMonths();
        ...
        {isLoading ? (
          ...
          <>
            ...
            <section className="widget-container">
              <WidgetItem
                percent={stats.changeInPercentage.revenue}
                amount={true}
              ...
              />
              <WidgetItem
                percent={stats.changeInPercentage.user}
                value={stats.count.user}
                color="rgb(0 198 202)"
                heading="Users"
              />
              <WidgetItem
                percent={stats.changeInPercentage.order}
                value={stats.count.order}
                color="rgb(255 196 0)"
                heading="Transactions"
              />
              <WidgetItem
                percent={stats.changeInPercentage.product}
            ...
            <section className="graph-container">
              <div className="revenue-chart">
                ...
                <BarChart
                  ...
                  data_2={stats.chart.orderMonthlyCount}
                  title_1="Revenue"
                  title_2="Transaction"
